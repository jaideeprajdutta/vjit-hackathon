...
onst handleFileUpload = (e) => {
    ...
    const validFiles = files.filter(file => {
      ...
      if (!allowedTypes.includes(file.type)) {
        setErrors(prev => ({ ...prev, attachments: `File ${file.name} has an unsupported format.` }));
        return false;
      }
      return true;
    });
 ...
 const generateReferenceId = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // In real app, this would be an API call to submit the grievance
      const grievanceData = {
        ...formData,
        referenceId,
                ...
                <div className="form-group">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      onChange={handleInputChange}
                      className={`pl-10 form-input ${errors.incidentDate ? 'border-red-500' : ''}`}
                      disabled={isSubmitting}
                ...
                <div className="form-group">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      onChange={handleInputChange}
                      className={`pl-10 form-input ${errors.incidentTime ? 'border-red-500' : ''}`}
                      disabled={isSubmitting}
                    />
                  </div>
                  {errors.incidentTime && (
                  ...
                  <div className="form-group">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        onChange={handleInputChange}
                        className={`pl-10 form-input ${errors.contactDetails ? 'border-red-500' : ''}`}
                        disabled={isSubmitting}
                      />
                    </div>
        ...
        {/* File Attachments */}
          <Card className="card-professional">
            <CardHeader>
              ...
              <CardDescription>
                Upload any relevant documents, images, or evidence (optional)
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              {/* File Upload Area */}
              <div className="border-2 border-dashed border-[#A2D5C6] rounded-lg p-8 text-center hover:border-[#CFFFE2] transition-colors duration-200">
              ...
              {attachments.length > 0 && (
                <div className="space-y-3">
                  <h4 className="font-medium text-black">Attached Files ({attachments.length})</h4>
